...
#     input()
    ...
    train_data = sc.read(train_path)  # (16893, 6998)
#     print(train_data[:10,:10])
#     input()
    labels = train_data.obs['cell_type']  # Categories (7, object): ['CD4T', 'CD14+Mono', 'B', 'CD8T', 'NK', 'FCGR3A+Mono', 'Dendritic']
#     print(labels)
#     input()
...
#     print('fefeff' , train_data.shape, flush=True)
...
#     print(len(train_data.var.index.tolist()))
#     print(pathway_mask)
#     input()
